...
<head>
    ...
    <title>Amada Temples- Tourist Information</title>
    ...
    <div class="container">
        ...
        <div class="hero-section">
            <div class="pyramid-image-container">
                <img src="Images/Amada Temples.jpg"
                    class="pyramid-image" alt="Great Pyramid of Giza">
            </div>
            <div class="description-card">
                <h2>About Amada Temples</h2>
                <p>The Temple of Amada is the oldest Egyptian temple in Nubia, constructed during the 18th Dynasty by Pharaoh Thutmose III and later embellished by his successors, Amenhotep II and Thutmose IV. Dedicated to the deities Amun-Ra and Re-Horakhty, the temple is renowned for its well-preserved reliefs and inscriptions that offer insights into ancient Egyptian religious practices and military campaigns. Notably, it contains vivid depictions of pharaohs making offerings to gods and historical records of military victories.</p>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="restaurants">
                        ...
                        <div class="restaurant">
                            ...
                            <p>  Serves traditional Egyptian cuisine and international favorites, catering to tourists visiting the nearby temples.</p>
                            <p>🍽️ Authentic Local</p>
                        </div>
                        <div class="restaurant">
                            <h3>Elephantine Restaurant at Mövenpick Resort Aswan</h3>
                            <p> Features a blend of local and international dishes, with both indoor and outdoor seating offering panoramic Nile views</p>
