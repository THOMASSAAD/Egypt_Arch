...
<head>
    ...
    <title>Cairo Citadel- Tourist Information</title>
    ...
    <div class="container">
        ...
        <div class="hero-section">
            <div class="pyramid-image-container">
                <img src="Images/Cairo Citadel.jpg"
                    class="pyramid-image" alt="Great Pyramid of Giza">
            </div>
            <div class="description-card">
                <h2>About Cairo Citadel</h2>
                <p>​The Cairo Citadel, also known as the Citadel of Saladin, is a prominent medieval Islamic-era fortification located in Islamic Cairo. Constructed between 1176 and 1183 by Salah ad-Din (Saladin), it served as Egypt's seat of government and the residence of its rulers for nearly 700 years, until the 19th century. Perched on the Mokattam Hills, the Citadel offers strategic views over Cairo and has been a symbol of the city's Islamic heritage. The complex includes several notable structures, such as the Mosque of Muhammad Ali, the Al-Gawhara Palace, and the Egyptian Military Museum. In 1979, it was designated as part of the UNESCO World Heritage Site "Historic Cairo".</p>
            </div>
        </div>
        ...
        <div class="main-content">
            ...
            <div class="amenities-container">
                ...
                <div class="card">
                    ...
                    <div class="restaurants">
                        <div class="restaurant">
                            <h3>Citadel View Restaurant</h3>
                            <p>Traditional Egyptian dishes served with a stunning view of the Saladin Citadel, renowned for its beautiful terrace and delicious food.</p>
                            <p>🍽️ Egyptian & International</p>
                        </div>
                        <div class="restaurant">
                            <h3>Abou Tarek</h3>
                            <p> Famed for its koshary, a traditional Egyptian dish, this 61-year-old eatery is frequented by locals and visitors alike. ​</p>
                            <p>🍽️ Authentic Local</p>
                        </div>
                        <div class="restaurant">
                            <h3>El Gahsh</h3>
                            <p> Offers a delightful all-day breakfast featuring fuul and tamiya, served until 4 a.m., providing an authentic local dining experience.​</p>
                ...
                <div class="card map-container">
                    <h2>Location Map</h2>
                    <iframe
                 src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3454.282727841455!2d31.257139475390236!3d30.028745674931553!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x145840ac90c2ed63%3A0x2fdb96e4e9f72e6f!2sCairo%20Citadel!5e0!3m2!1sen!2seg!4v1744920406715!5m2!1sen!2seg" 
